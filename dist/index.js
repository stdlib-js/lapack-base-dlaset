...
var J=require('@stdlib/blas-base-assert-is-layout/dist'),K=require('@stdlib/ndarray-base-assert-is-column-major-string/dist'),O=require('@stdlib/error-tools-fmtprodmsg/dist'),P=j();function Q(e,a,f,s,u,i,n,o){var r,t;if(!J(e))throw new TypeError(O('nullFx',e));if(K(e))r=1,t=o;else{if(o<s)throw new RangeError(O('nullG9',s,o));r=o,t=1}return P(a,f,s,u,i,n,r,t,0)}S.exports=Q
